...
export type Query = {
  ...
  generateNewAccessToken: Scalars['String']['output'];
...
export type GetNewAccessTokenQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNewAccessTokenQuery = { __typename?: 'Query', generateNewAccessToken: string };
...
export const GetNewAccessTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getNewAccessToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateNewAccessToken"}}]}}]} as unknown as DocumentNode<GetNewAccessTokenQuery, GetNewAccessTokenQueryVariables>;