    ...
    return (
      <button
        className={clsx(
          ...
          "hover:border-primary-400 dark:bg-primary-300 dark:hover:bg-primary-200 border-transparent bg-slate-50 hover:bg-slate-200",
        )}
    ...
    <div className="group/accordion my-2">
      <button
        className={clsx(
          ...
          "group-hover/accordion:border-primary-400 dark:bg-primary-300 group-hover/accordion:dark:bg-primary-200 border-transparent bg-slate-50 group-hover/accordion:bg-slate-200",
        )}
      >
        <span>
          <Icon icon={props.icon} className="text-lg" />
      ...
      <div
        className={clsx(
          ...
          "dark:bg-primary-300 grid bg-slate-100 transition-[grid-template-rows_padding] duration-300",
            ...
            <li key={o.label + i}>
              <button
                ...
                className={clsx(
                  ...
                  "hover:border-primary-400 dark:bg-primary-300 dark:hover:bg-primary-350 border-transparent bg-slate-200 hover:bg-slate-50",
                )}
              >
                {o.label}
              </button>
