...
export function AuthFormContainer(props: Props) {
  return (
    <form
      className="dark:bg-primary-900 bg-primary-50 flex w-full max-w-[520px] flex-col gap-5 px-[60px] py-[50px] transition-colors duration-300 max-sm:px-[30px] max-sm:py-[35px] lg:my-5 lg:mt-10 lg:max-w-[1000px] lg:px-[80px] lg:py-[70px]"
